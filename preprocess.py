...
# input (master) source
_REPORT_NAME = "source_report_kirgizsky_2024.md"
# output source
_REPORT_NAME_CH = "source_report_kirgizsky_2024_ch.md"

# Output files:
# Markdown, for github/view
_OUTPUT_REPORT_NAME_MD = "report_kirgizsky_2024.md"
# PDF, for site/upload
_OUTPUT_REPORT_NAME_PDF = "report_kirgizsky_2024_pdf.md"
# PDF, for champ
_OUTPUT_REPORT_NAME_CH = "report_kirgizsky_2024_ch.md"
