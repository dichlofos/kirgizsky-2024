...
Записку класть особо некуда: седловина хоть и широкая, но всё настолько неплохо засыпано снегом,
...
Можем считать, что перевал соответствует перевалу категории 1Б, но его можно отнести к
классу несложных 1Б, которые могут быть рекомендованы для всех групп без исключения. Можем даже назвать его учебным:
...
Однако понижать категорию до 1А не стОит.
